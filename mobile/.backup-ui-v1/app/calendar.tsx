    ...
    <>
      ...
      <SafeAreaView style={styles.container} edges={['bottom']}>
                  ...
                  <View style={styles.dotsRow}>
                    {uniqueTypes.slice(0, 3).map((t) => (
                      <View
                        ...
                        style={[
                          styles.dot,
                          { backgroundColor: isToday ? '#fff' : EVENT_COLORS[t] || '#6b7280' },
                        ]}
                      />
                    ))}
                  </View>
        ...
        <ScrollView style={styles.eventsList}>
          ...
          {isLoading && <ActivityIndicator style={{ marginTop: 20 }} color="#004225" />}
          ...
          {selectedEvents.map((ev, i) => (
            <View key={i} style={styles.eventRow}>
              <View
                style={[
                  styles.eventDot,
                  { backgroundColor: EVENT_COLORS[ev.type] || '#6b7280' },
                ]}
              />
              <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  navBtn: { padding: 8 },
  monthLabel: { fontSize: 18, fontWeight: '600', color: '#111' },
  ...
  eventsTitle: { fontSize: 16, fontWeight: '600', color: '#111', marginBottom: 12 },
  noEvents: { fontSize: 14, color: '#9ca3af', textAlign: 'center', marginTop: 20 },
  eventRow: {
    flexDirection: 'row',
  ...
  eventDetail: { fontSize: 11, color: '#6b7280' },
});
