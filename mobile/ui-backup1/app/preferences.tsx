      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={() => router.back()} style={styles.backButton}>
            <FontAwesome name="chevron-left" size={16} color="#004225" />
...
const styles = StyleSheet.create({
  ...
  backText: { color: '#004225', fontSize: 16, fontWeight: '500' },
  ...
  pickerValue: { fontSize: 16, color: '#111827', fontWeight: '500' },
  doneButton: { alignItems: 'flex-end', paddingVertical: 4 },
  doneText: { color: '#004225', fontSize: 16, fontWeight: '600' },
  targetRow: {
    flexDirection: 'row',
  ...
  targetLabel: { fontSize: 15, color: '#6b7280', fontWeight: '500' },
  ...
  minutesSuffix: { fontSize: 14, color: '#6b7280' },
  ...
  timeLabel: { fontSize: 15, color: '#6b7280', fontWeight: '500' },
  ...
  toggleActive: { backgroundColor: '#004225' },
  toggleThumb: {
    width: 24,
    height: 24,
    borderRadius: 12,
