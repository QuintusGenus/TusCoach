...
import { fetchMessageByWorkflowRun, markMessageRead } from '../../src/api/coach';
...
export default function MessageDetailPage() {
    ...
    const workflowRunId = parseInt(params.workflow_run_id as string, 10);

    // Fetch message data
    const { data: message, isLoading, error } = useQuery({
        queryKey: ['message', workflowRunId],
        queryFn: () => fetchMessageByWorkflowRun(workflowRunId),
        enabled: !isNaN(workflowRunId),
    });
    ...
    const markReadMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: ['message', workflowRunId] });
