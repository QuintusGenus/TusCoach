      ...
      <SafeAreaView style={styles.container} edges={['bottom']}>
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyState}>
            <FontAwesome name="sticky-note-o" size={48} color={colors.gray[300]} />
            ...
            <View style={{ padding: 16, gap: 10 }}>
              {notes.map((note) => {
                const color = note.subject
                  ? SUBJECT_COLORS[note.subject as TUSSubject] || colors.gray[500]
                  : colors.gray[500];
                return (
                  <TouchableOpacity
                    key={note.id}
...
const styles = StyleSheet.create({
  ...
  noteTitle: { fontSize: 15, fontWeight: '600', color: colors.gray[900] },
  ...
  noteDate: { fontSize: 11, color: colors.gray[400] },
  notePreview: {
    fontSize: 13,
